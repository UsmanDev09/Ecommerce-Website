...
const store = createStore(reducer,
    {
        ...
        productQuantity :  localStorage.getItem('productQuantity') === null? [] : localStorage.getItem('productQuantity').split(','),
        ...
        productImage: localStorage.getItem('productImage') === null? [] : localStorage.getItem('productImage').split(','),
        productPrice: localStorage.getItem('productPrice') === null? [] : localStorage.getItem('productPrice').split(','),
